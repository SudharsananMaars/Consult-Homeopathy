  ...
  return (
    <div className="flex flex-col lg:flex-row justify-center space-x-6">
      ...
      <div className="sm:w-1/2 space-y-8 p-5 bg-white rounded-lg shadow-md">
        {/* Consulting Person */}
        <div>
          <label className="block text-lg font-bold text-gray-700 mb-10 text-center bg-blue-100 p-4 rounded-lg shadow">
            Book an Appointment
          </label>
      ...
      <div className="p-5 bg-white sm:w- rounded-lg shadow-lg">
        ...
        <div className="p-4">
          ...
          {consultingForError && (
            <p className="text-red-500 text-sm mt-2">{consultingForError}</p>
          )}
          {fullNameError && (
            <p className="text-red-500 text-sm mt-2">{fullNameError}</p>
          )}
          {consultingReasonError && (
            <p className="text-red-500 text-sm mt-2">{timeError}</p>
          )}
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center">
          <div className="bg-white p-6 rounded-lg shadow-lg sm:w-1/4 sm:h-1/4">
            ...
            <p className="mb-4">
              ...
              {startDate ? startDate.format("DD-MM-YYYY") : ""} at{" "}
              {selectedTime}
            </p>
