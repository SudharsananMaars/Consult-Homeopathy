...
const FrequencyModal = ({
    ...
    return weeks.map((week, weekIndex) => (
      <div key={weekIndex} className="flex gap-1 mb-1">
        {week.map((day) => {
          ...
          const rangeColors = ["bg-blue-500 border-blue-500", "bg-green-500 border-green-500", "bg-purple-500 border-purple-500", "bg-orange-500 border-orange-500", "bg-pink-500 border-pink-500", "bg-blue-500 border-blue-500"];
          const selectedRangeColors = ["bg-blue-600 border-blue-600", "bg-green-600 border-green-600", "bg-purple-600 border-purple-600", "bg-orange-600 border-orange-600", "bg-pink-600 border-pink-600", "bg-blue-600 border-blue-600"];
  ...
  const renderRangeSummary = () => {
    ...
    const rangeColors = ["bg-blue-100 border-blue-300 text-blue-800", "bg-green-100 border-green-300 text-green-800", "bg-purple-100 border-purple-300 text-purple-800", "bg-orange-100 border-orange-300 text-orange-800", "bg-pink-100 border-pink-300 text-pink-800", "bg-blue-100 border-blue-300 text-blue-800"];
