...
import AddDoctorModal from "/src/pages/doctor pages/AddDoctorModal"; // Import the AddDoctorModal component
...
const AssistDoc = () => {
    ...
    const [doctors, setDoctors] = useState([
        ...
        { id: "D002", name: "Dr. Jane Adams", createdAt: "2024-02-18", phone: "098-765-4321", email: "janeadams@example.com", status: "inactive" },
        { id: "D003", name: "Dr. Emily Johnson", createdAt: "2024-03-05", phone: "234-567-8901", email: "emilyjohnson@example.com", status: "active" },
    ]);
    ...
    return (
        <DoctorLayout>
            <div className="p-7">
                <h1 className="text-2xl font-semibold mb-4"> Assistent Doctors</h1>
