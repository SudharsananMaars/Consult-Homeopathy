    ...
    if (validateFields()) {
      try {
        ...
        if (response.data.success) {
          ...
          localStorage.setItem("userRole", "Med-Prep");
          alert("OTP verified successfully!");
          navigate("/medicine-preparation/dashboard");
...
export default MedicinePreparerLogin;