...
import referfrnd from "../assets/images/referfrnd.png";
...
const ReferFriend = () => {
    ...
    const handleSubmit = (e) => {
        ...
        if (validateForm()) {
            ...
            alert("Congrats! You have referred your friend");
        }
    };
                                ...
                                {friendsData.map((friend, index) => (
                                    <tr key={index}>
                                        ...
                                        <td className="py-2 px-4 border ">
                                            <button className="bg-blue-500 text-white px-4 py-2 justify-items-center rounded-md">Redeem</button>
                                        </td>
                                    </tr>
                                ))}
                            </tbody>
